...
**quotenorm-ai** — Developer-first, agent-ready quote normalization API. Gated execution: Phase 1 = /normalize (text+PDF+URL) + Stripe + Python SDK. Phase 2+ gated on month-4 usage signal. Next: collect sample quotes, validate schema, scaffold project.
