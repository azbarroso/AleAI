...
| 2026-03-12 | Express + TypeScript tech stack | x402 `@x402/http` has native Express middleware. QuoteNorm is a pure API — no SSR, no React, no pages. Express is simpler and cleaner. Deploy on Railway or Vercel (Express adapter). |
